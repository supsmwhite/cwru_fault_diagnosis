...
EPOCH_LOG_PATH = LOG_DIR / "cross_load_se_resnet1d_epoch_log.csv"
SUMMARY_PATH = LOG_DIR / "cross_load_se_resnet1d_summary.csv"

ACC_MATRIX_FIG_PATH = FIGURE_DIR / "se_resnet1d_cross_load_accuracy_matrix.png"
F1_MATRIX_FIG_PATH = FIGURE_DIR / "se_resnet1d_cross_load_macro_f1_matrix.png"
...
def train_source_load(source_load, device):
    ...
    print("=" * 80)
    print(f"Cross-load SE-ResNet1D | Train Load {source_load} hp")
    print("=" * 80)
    print("Device:", device)
...
def main():
    ...
    print("=" * 80)
    print("Day 8: SE-ResNet1D cross-load generalization experiments")
    print("=" * 80)
    print("Device:", device)
    print("Epochs:", EPOCHS)
    ...
    plot_matrix(
        acc_matrix,
        "SE-ResNet1D Cross-Load Accuracy Matrix",
        ACC_MATRIX_FIG_PATH,
    )

    plot_matrix(
        f1_matrix,
        "SE-ResNet1D Cross-Load Macro-F1 Matrix",
        F1_MATRIX_FIG_PATH,
    )

    print("=" * 80)
    print("Cross-load SE-ResNet1D experiments finished.")

...
EPOCH_LOG_PATH = LOG_DIR / "leave_one_load_out_se_resnet1d_epoch_log.csv"
SUMMARY_PATH = LOG_DIR / "leave_one_load_out_se_resnet1d_summary.csv"

ACC_BAR_FIG_PATH = FIGURE_DIR / "se_resnet1d_leave_one_load_out_accuracy_bar.png"
F1_BAR_FIG_PATH = FIGURE_DIR / "se_resnet1d_leave_one_load_out_macro_f1_bar.png"
...
def train_leave_one_load_out(target_load, device):
    ...
    model = SEResNet1D(num_classes=NUM_CLASSES).to(device)
    ...
    print("=" * 80)
    print(f"SE-ResNet1D leave-one-load-out | Test Load {target_load} hp")
    print("=" * 80)
    print("Device:", device)
...
def main():
    ...
    print("=" * 80)
    print("SE-ResNet1D leave-one-load-out experiments")
    print("=" * 80)
    print("Device:", device)
    print("Epochs:", EPOCHS)
    ...
    plot_bar(
        ...
        title="SE-ResNet1D Leave-One-Load-Out Accuracy",
        ylabel="Accuracy",
    ...
    plot_bar(
        ...
        title="SE-ResNet1D Leave-One-Load-Out Macro-F1",
        ylabel="Macro-F1",
        save_path=F1_BAR_FIG_PATH,
    )

    print("=" * 80)
    print("SE-ResNet1D leave-one-load-out experiments finished.")

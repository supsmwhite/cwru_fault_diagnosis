...
LOG_PATH = LOG_DIR / "cnn1d_baseline_30epoch_log.csv"
BEST_MODEL_PATH = CHECKPOINT_DIR / "cnn1d_baseline_30epoch_best.pt"
LOSS_FIG_PATH = FIGURE_DIR / "cnn1d_baseline_30epoch_loss_curve.png"
METRIC_FIG_PATH = FIGURE_DIR / "cnn1d_baseline_30epoch_metric_curve.png"
...
def save_figures(history):
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.title("CNN1D Smoke Test Loss Curve")
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Score")
    plt.title("CNN1D Smoke Test Metric Curve")
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
...
def main():
    ...
    print("=" * 80)
    print("CNN1D baseline 30-epoch training")
    print("=" * 80)
    print("Device:", device)

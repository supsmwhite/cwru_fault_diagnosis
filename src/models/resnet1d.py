...
class BasicBlock1D(nn.Module):
    """
    ResNet1D basic residual block.

    Input:
        x: [batch_size, in_channels, length]

    Output:
        out: [batch_size, out_channels, new_length]
    """
...
class ResNet1D(nn.Module):
    """
    ResNet1D model for CWRU bearing fault diagnosis.
